...
class IonAuth extends \CodeIgniter\Config\BaseConfig
{
	...
	/*
	 ...
	 |		It is recommended to have a stronger hashing for administrators.
	 |
	 | For more information, check the password_hhttps://www.youtube.com/watch?v=uaFzmZrKKKw&list=RDGMEM_v2KDBP3d4f8uT-ilrs8fQ&start_radio=1ash function help: http://php.net/manual/en/function.password-hash.php
	 |
	 */
